...
//  opengl
//
//  Created by Pringgo Juni Saputro on 05/01/19.
//  Copyright © 2019 Pringgo Juni Saputro. All rights reserved.
//
...
int main(int iArgc, char** cppArgv) {
    ...
    glutCreateWindow("Pringgo Juni Saputro - Diamond");
    Initialize();
